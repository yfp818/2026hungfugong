          ...
          <div className="p-8 md:p-12">
            <form onSubmit={handleAddToCart} className="space-y-12 animate-in fade-in duration-500">
              ...
              <div className="space-y-6 border-t border-stone-200/60 pt-8">
                ...
                <input required value={birthDate} onChange={e=>setBirthDate(e.target.value)} placeholder="出生年月日 (例: 國曆 78 年 5 月 20 日 吉時)" className="w-full bg-stone-50 border border-stone-200 p-4 rounded-xl outline-none focus:ring-2 focus:ring-[#A61D24] transition-all font-medium"/>
